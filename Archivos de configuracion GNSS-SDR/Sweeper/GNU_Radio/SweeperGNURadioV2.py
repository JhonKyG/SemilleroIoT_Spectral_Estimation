...
class SweeperGNURadioV2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SweeperGNURadioV2")
        ...
        self.func = func = 0
        self.timo = timo = epy_module_0.funTime(funcTime)
        self.freq = freq = epy_module_0.sweeper(func)
        self.timee = timee = timo
        ...
        self._timee_tool_bar.addWidget(Qt.QLabel('Time' + ": "))
    ...
    def set_funcTime(self, funcTime):
        ...
        self.set_timo(epy_module_0.funTime(self.funcTime))
    ...
    def set_timo(self, timo):
        self.timo = timo
        self.set_timee(self._timee_formatter(self.timo))
...
def main(top_block_cls=SweeperGNURadioV2, options=None):
