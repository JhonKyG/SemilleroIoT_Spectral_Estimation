...
% based only. 
settings.skipNumberOfBytes     = 2*16e6; % 200, 7 sats, works!!!!!!!!!!!!!!!!! 300sec
...
% 120s sample worked!
settings.fileName = ...
     'C:\Users\JUAN\OneDrive - Universidad Sergio Arboleda\Documentos\GPS_receiver(5)\GPS_receiver\Grabacion_#27_04_2022INPUTFILTER.dat'; 
...
settings.dllNoiseBandwidth       = 2*2;       %[Hz]
settings.dllCorrelatorSpacing    = 0.5;     %[chips]

% Carrier tracking loop parameters
settings.pllDampingRatio         = 0.7;
settings.pllNoiseBandwidth       =  2*25;      %[Hz]
